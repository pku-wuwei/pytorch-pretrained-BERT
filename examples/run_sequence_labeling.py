...
class DataProcessor(object):
    ...
    def get_train_examples(self, data_dir):
        ...
        return DataProcessor._create_examples(os.path.join(data_dir, 'train.char.bmes'), 'train')

    def get_dev_examples(self, data_dir):
        """Gets a collection of `InputExample`s for the dev set."""
        return DataProcessor._create_examples(os.path.join(data_dir, 'dev.char.bmes'), 'dev')
...
def main():
    ...
    model = BertForTokenClassification.from_pretrained(args.bert_model, state_dict=model_state_dict,
                                                          num_labels=num_labels)
    model.to(device)
